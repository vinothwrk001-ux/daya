...
router.get("/homepage-builder/containers/schema/:type", requireWorkspacePermission("settings.read"), homepageLayoutController.getBuilderContainerSchema);
...
router.get("/homepage-layouts", requireWorkspacePermission("settings.read"), homepageLayoutController.listAdminLayouts);
router.post("/homepage-layouts", requireWorkspacePermission("settings.update"), express.json(), homepageLayoutController.createAdminLayout);
router.get("/homepage-layouts/:id", requireWorkspacePermission("settings.read"), homepageLayoutController.getAdminLayoutById);
router.put("/homepage-layouts/:id", requireWorkspacePermission("settings.update"), express.json(), homepageLayoutController.updateAdminLayoutDraft);
router.post("/homepage-layouts/:id/publish", requireWorkspacePermission("settings.update"), homepageLayoutController.publishAdminLayout);
router.delete("/homepage-layouts/:id", requireWorkspacePermission("settings.update"), homepageLayoutController.deleteAdminLayout);
