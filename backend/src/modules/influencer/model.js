...
const influencerApplicationDocumentSchema = new mongoose.Schema(
  {
    ...
    documentType: {
      type: String,
      enum: ["sample_content", "brand_collaboration", "identity_document"],
      required: true,
      index: true,
    },
...
const influencerCollectionSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ["recommended_products", "tech_essentials", "fashion_picks", "creator_favorites", "trending_products", "custom"],
      default: "custom",
      index: true,
    },
